...
import {Pray} from '../windows'
import * as ACTIONS from '../actions/actions/actions';



class _Pray extends Component {
  constructor(props){
    super(props)
  ...
  render() {
    ...
    return (
        <Pray
          ...
          onItemNextPressed={()=> this.props.dispatch({type: 'GoToRepeatRightToLeftAnimation'})}
...
export default connect(mapStateToProps)(_Pray);
